		...
		int posx, int posy, int width, int height, int mib_fill)
{
  ...
  myres = (mib_TextBig *)malloc(sizeof(mib_TextBig));
...
void mib_delete_TextBig(mib_Widget *this)
{
  mib_TextBig *temp = (mib_TextBig *)this->myres;

  free(temp);
}

void mib_save_TextBig(mib_Widget *this, FILE *fout)
{
}

int mib_load_TextBig(mib_Widget *this, mib_Buffer *fin)
{
